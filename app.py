...
catalogo = Catalogo(host='vepersano.mysql.pythonanywhere-services.com', user='vepersano', password='veryto25', database='vepersano$miapp')
...
RUTA_DESTINO = '/home/vepersano/mysite/static/imagenes'
